...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private float[] mMagnetomenterData = new float[3];
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType){
            ...
            case Sensor.TYPE_MAGNETIC_FIELD:
                mMagnetomenterData = sensorEvent.values.clone();
                break;
            default:
                break;
        }
        ...
        SensorManager.getRotationMatrix(rotationMatrix, null,mAccelerometerData,mMagnetomenterData);
